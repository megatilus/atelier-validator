...
public val AtelierValidatorClientConfigKey: AttributeKey<AtelierValidatorClientConfig> =
    AttributeKey("dev.megatilus.atelier.ktor.client.AtelierValidatorClientConfig")
 ...
 */
public inline fun <reified T : Any> HttpClient.getValidator(): AtelierValidator<T>? {
 ...
 * @return The validator for type T, or null if no validator is registered
 */
public inline fun <reified T : Any> HttpResponse.getValidator(): AtelierValidator<T>? {
